window.onload = function () {
  ...
  function remainingTime(targetDate, getOgj) {
    if (targetDate.year === undefined) return;
    if (targetDate.month === undefined) targetDate.month = 0;
    if (targetDate.day === undefined) targetDate.day = 1;
    ...
    if (!getOgj) return diff;

    getOgj = {};

    getOgj.days = Math.floor(diff / 1000 / 86400);
    getOgj.hours = Math.floor((diff / 1000 - getOgj.days * 86400) / 3600);
    getOgj.minutes = Math.floor(
      (diff / 1000 - getOgj.days * 86400 - getOgj.hours * 3600) / 60
    );
    getOgj.seconds = Math.floor(
      diff / 1000 -
        getOgj.days * 86400 -
        getOgj.hours * 3600 -
        getOgj.minutes * 60
